...
`Tools/preview_table.py` and `Tools/preview_detail.py`. They mirror the SwiftUI
layout arithmetic rather than rendering the real app, so they are useful for
checking composition, tile legibility and density — not for the App Store.

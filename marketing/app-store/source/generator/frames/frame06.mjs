/* 06  PROGRESS.  The closing image: one large device, perfectly vertical, pushed
   ...
   Background hierarchy
     ...
     secondary  a balanced equation along the bottom
     ambient    one very large orbit diagram centred on the device, so only its
                left lobe surfaces in the open margin
...
export default {
  ...
  deco: () => [
    periodicFragment({ x: -180, y: 2300, cell: 80, gap: 12, opacity: 0.08 }),
    orbits({ cx: 924, cy: 1660, r: 820, opacity: 0.025, width: 6, flatten: 0.4 }),
    formula(EQUATIONS.combustionH2, { x: 96, y: 2846, size: 52, opacity: 0.035 }),
  ],
};
